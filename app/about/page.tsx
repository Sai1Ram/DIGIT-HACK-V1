...
export default function About() {
  return (
    <Container>
      ...
      {/* ===== TOP SECTION ===== */}
      <Section>
        <div className="w-full flex flex-col md:flex-row md:items-end md:justify-between gap-6 lg:gap-10 xl:gap-16">
          {/* Left */}
        ...
        <Section>
          <div className="relative z-5 flex flex-col md:flex-col lg:flex-row gap-8 md:gap-10 lg:gap-14 xl:gap-20 w-full">
            ...
            <div className="w-full space-y-8 sm:space-y-10">
              ...
              {/* Mission / Vision */}
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-6 lg:gap-8 text-gray-700">
                <Reveal
                  direction="right"
                  distance={30}
                  duration={0.5}
